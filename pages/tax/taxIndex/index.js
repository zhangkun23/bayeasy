...
Component({
    ...
    data: {
        img1_1: app.globalData.imgPath + "tax/gates/taxReturn.png",
        img1_2: app.globalData.imgPath + "tax/gates/financialStatements.png",
        img2_1: app.globalData.imgPath + "tax/gates/annualReport.png",
        img2_2: app.globalData.imgPath + "tax/gates/annuelVersement.png",
        statusBarHeight: 30,
        pageShow: false,
        showModal: false,
        textInfo: '登录/注册',
