...
Component({
  ...
  methods: {
    ...
    afterTapDate(e) {
      ...
      const end_date = end.getFullYear() + '-' + (end.getMonth() + 1) + '-' + end.getDate()
      const __target = e.currentTarget.id
      if (__target === "cid") {
        this.setData({
          iStartDate: start_date,
          iEndDate: end_date,
          iDefaultDate: [start.getTime(), end.getTime()],
          showInvoiceDate: false
        })
      } else if (__target === "ccd") {
        this.setData({
          cStartDate: start_date,
          cEndDate: end_date,
          cDefaultDate: [start.getTime(), end.getTime()],
          showCreateCal: false
        })
      }
      return
    ...
    initData() {
      ...
      const initConfig = {
        ...
        calendarStartDate:new Date('2022-01-01').getTime(),
        calendarEndDate: new Date().getTime(),
        calendar_config_cd: {
